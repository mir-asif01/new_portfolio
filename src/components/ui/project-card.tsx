      ...
      <div className="p-5">
        ...
        <p className="my-3">
          {tags.map((tag, idx) => (
            <span
              key={idx}
              className="mr-3 text-xs dark:bg-gray-500 bg-sky-400 px-2 py-1 rounded-full text-gray-800 dark:text-sky-500"
            >
              {tag}
            </span>
          ))}
        ...
        <p className="my-3">
          {techStack.map((tech, idx) => (
            <span
              key={idx}
              className="text-xs mr-2 rounded-full dark:bg-gray-500 bg-gray-200 px-2 py-1"
            >
              {tech}
            </span>
          ))}
